...
// Note from Sergey: excessive params and non-local methods are required to avoid closure allocations, do not refactor
namespace Asteroids.Utils.Extension_Methods.RX.Collections
{
