...
namespace Asteroids.Utils.Extension_Methods.RX
{
    public static class RxObservableExtensions
    {
        public static IObservable<T> WhereNotNull<T>(this IObservable<T> observable) where T : class =>
            observable.Where(v => !v.IsUnityNull());
        ...
        public static IObservable<T> SelectValue<T>(this IObservable<CollectionAddEvent<T>> eventObservable) =>
            eventObservable.Select(e => e.Value);
        ...
        public static IObservable<TR> AsObservable<T, TR>(this IObservable<T> observable, TR value) =>
            observable.Select(_ => value);

        public static IObservable<UniRx.Unit> ToAnyCompletedObservable<T>(this IEnumerable<IObservable<T>> observables)
        {
            var subject = new Subject<UniRx.Unit>();
        ...
        )
        {
            ...
            var subscriptionDisposable = observable.SubscribeWithState((valueProperty, produce, dispose), (source, state) =>
            {
        ...
        public static IDisposable ChainedSubscribe<T>(this IObservable<T> observable, Action<T, CompositeDisposable> innerSubscribe)
        {
        ...
        public static IDisposable ChainedSubscribe<T>(this IObservable<T> observable, Func<T, IDisposable> innerSubscribe)
        {
